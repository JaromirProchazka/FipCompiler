...
namespace cecko
{
	...
	{
		bool eq = ret_type_ == b.ret_type_ && arg_types_.size() == b.arg_types_.size() && variadic_ == b.variadic_;
	...
	void CKTables::declare_library()
	{
		...
		globtable_.declare_function("@malloc", module_, typetable_.get_function_type(t_ptr_void, {t_int}, false), "ckrt_malloc");
